<script lang="ts">
    ...
    let adsKillswitchActive = false;
    let malwareKillswitchActive = false;
    let scamsKillswitchActive = false;
    let allKillswitchesActive = false;
    ...
    async function initTabInfo() {
        console.debug("PageCurrentWebsite: Initializing tab info");
        const tabInfo = await getTabInfo();
        console.debug("PageCurrentWebsite: Tab info", {tabInfo});
    ...
    async function getCurrentWebsiteExclusions() {
        console.debug("PageCurrentWebsite: Getting current website exclusions");
        ...
        adsKillswitchActive = adsKillswitchOn;
        malwareKillswitchActive = malwareKillswitchOn;
        scamsKillswitchActive = scamsKillswitchOn;
        allKillswitchesActive =
            adsKillswitchOn && malwareKillswitchOn && scamsKillswitchOn;
...
<div class="flex flex-row mt-4 gap-6 w-full h-full">
    <div class="protection-controls">
        <ProtectionControls
            bind:isAdsKillswitchActive={adsKillswitchActive}
            bind:isMalwareKillswitchActive={malwareKillswitchActive}
            bind:isScamsKillswitchActive={scamsKillswitchActive}
    ...
    <div class="protection-status">
        ...
        {:else}
            <ProtectionStatus
                bind:currentHost
                {isProtectionActive}
                bind:isKillswitchActive={allKillswitchesActive}
